...
title:  "ZIO-memberlist Contributor Guidelines"
---
...
```bash
mkdir zio-memberlist
cd zio-memberlist
git clone git@github.com:your-user-name/zio-memberlist.git .
```
...
You may have your own idea about what contributions to make to ZIO, which is great! If you want to make sure the ZIO contributors are open to your idea, you can [open an issue](https://github.com/zio/zio-memberlist/issues/new) first on the ZIO project site.

Otherwise, if you have no ideas about what to contribute, you can find a large supply of feature requests and bugs on the project's [issue tracker](https://github.com/zio/zio-memberlist/issues).
